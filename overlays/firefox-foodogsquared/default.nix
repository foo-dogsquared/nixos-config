...
{
  firefox-foodogsquared = with prev;
    wrapFirefox firefox-unwrapped {
      nativeMessagingHosts = [ ff2mpv bukubrow tridactyl-native ];
      ...
      extraPolicies = {
        ...
        ExtensionSettings = let
          ...
          extensions = {
            ...
            "{157eb9f0-9814-4fcc-b0b7-586b3093c641}".install_url =
              mozillaAddon "updateswh";
            "{15bdb1ce-fa9d-4a00-b859-66c214263ac0}".install_url =
              mozillaAddon "get-rss-feed-url";
            "{446900e4-71c2-419f-a6a7-df9c091e268b}" = {
              install_url = mozillaAddon "bitwarden-password-manager";
              installation_mode = "force_installed";
              default_area = "navbar";
            };
            "{dedb3663-6f13-4c6c-bf0f-5bd111cb2c79}".install_url =
              mozillaAddon "zhongwen";
            "{ef87d84c-2127-493f-b952-5b4e744245bc}".install_url =
              mozillaAddon "aw-watcher-web";
            "ff2mpv@yossarian.net" = {
              install_url = mozillaAddon "ff2mpv";
              default_area = "navbar";
            };
            "FirefoxColor@mozilla.com".install_url =
              mozillaAddon "firefox-color";
            ...
            "regrets-reporter@mozillafoundation.org".install_url =
              mozillaAddon "regretsreporter";
            ...
            "zotero@chnm.gmu.edu".install_url =
  ...
  # environments.
  firefox-foodogsquared-guest = with prev;
    wrapFirefox firefox-unwrapped {
